...
#===========================================================================================================
def eval_oei_performances(aircraft):
    """
    Compute one engine inoperative maximum path
    """

    disa_oei = aircraft.low_speed.disa_oei
    oei_ceil_req = aircraft.low_speed.req_oei_altp

    oei_path,oei_speed = perfo.oei_max_path(aircraft,disa_oei,oei_ceil_req)
...
def eval_oei_path(aircraft):
    ...
    disa_oei = aircraft.low_speed.disa_oei
    oei_ceil_req = aircraft.low_speed.req_oei_altp
    oei_speed = aircraft.low_speed.oei_best_speed

    oei_path = perfo.oei_path(aircraft,disa_oei,oei_ceil_req,oei_speed)
...
def eval_climb_performances(aircraft):
    ...
    disa = aircraft.high_speed.disa_climb

    vz_clb,vz_crz = perfo.climb_speeds(aircraft,disa,toc,mach)

...
class HorizontalTail(object):
    ...
    "htp_sizing_constraint_1":{"unit":"no_dim", "om":1.e0, "txt":"Constraint on horizontal tail reference area"},
...
class VerticalTail(object):
    ...
    "vtp_sizing_constraint_1":{"unit":"no_dim", "om":1.e0, "txt":"Constraint on vertical tail reference area"},

...
# MDA process
#======================================================================================================
# This sequence reproduces what is done by eval_mda2 of process.assembly.py depending with in addition a
# direct HQ optimization of HTP and VTP areas without update of characteristic weights MTOW, MLW & MZFW
# consequently, at the end of this process, the airplane is supposed to be NOT consistant but if HTP
# and VTP area predesign is close to the optimum delivered by HQ then the airplane is very close to
# consistancy
